...
def graphes2(classeur: Workbook) -> None:
    ...
    zone_graph(
        feuille,
        "Les 10 stations les plus et les moins fréquentées par les "
    ...
    feuille.add_chart(
        bar_horiz_graph(
            Reference(
                classeur["stations"], min_col=23, max_col=24, min_row=1, max_row=21
            ),
            Reference(classeur["stations"], min_col=13, min_row=2, max_row=21),
        ),
        "B3",
    )
    feuille.add_chart(
        bar_horiz_graph(
            Reference(
                classeur["stations"], min_col=37, max_col=38, min_row=1, max_row=21
            ),
            Reference(classeur["stations"], min_col=26, min_row=2, max_row=21),
        ),
        "M3",
    )
